...
static int load_prog(int fd)
{
	struct bpf_insn insn[] = {
		...
		BPF_LD_IMM64(BPF_REG_7, A64INT),              /* r7 = 2^61 */
		...
		BPF_STX_MEM(BPF_DW, BPF_REG_3, BPF_REG_7, 0), /* *r3 = r7 */
		...
		BPF_LD_IMM64(BPF_REG_7, A64INT),              /* r7 = 2^60 */
		...
		BPF_MOV64_IMM(BPF_REG_4, BPF_ANY),        /* r4 = BPF_NOEXIST */
